    ...
    <div class="flex h-full min-h-screen">
        ...
        <aside class="w-64 bg-[#011B33] flex flex-col flex-shrink-0 fixed inset-y-0 left-0 z-30">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
                ...
                <div class="px-3 pt-3 border-t border-white/10 mt-3">
                    <a href="{{ route('docs') }}"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-white/40
              hover:text-white/70 hover:bg-white/8 transition-colors text-sm">
