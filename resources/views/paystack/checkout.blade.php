...
<head>
  ...
  <title>Paystack Checkout — DevWallet Sandbox</title>
...
<body class="min-h-screen bg-slate-100 flex items-center justify-center font-sans p-4">
  ...
  <div class="w-full max-w-sm">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      {{-- Header --}}
      <div class="bg-[#00C3F7]/10 border-b border-[#00C3F7]/20 px-6 py-5">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl bg-[#00C3F7]/20 flex items-center justify-center">
            <span class="text-[#00C3F7] font-bold">P</span>
          </div>
          <div>
            <p class="text-xs font-medium text-slate-500">Paystack · Sandbox</p>
    ...
    <p class="text-center text-xs text-slate-400 mt-4">
      Ref: <span class="font-mono">{{ $tx->reference }}</span>
    </p>
